...
# TODO: ------------------------------------------------------------------------
#       All of the following needs to go when fixed in datalad! Just maintaining
#       a copy for now, because of issue 158. Not waiting for another release to
#       depend on.
#       Actual issue: AnnexRepo.get() doesn't take a list when key=True. Working
#       around here in the dataset caching helpers, but should ultimately be
#       resolved in datalad core in AnnexRepo.
#       ------------------------------------------------------------------------
